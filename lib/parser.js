...
module.exports = function parse (line) {
    ...
    var valid = ['such', 'wow', 'wow&', 'plz', '.plz', 'dose', 'very', 'always', 'shh', 'quiet', 'loud', 'rly', 'but', 'many', 'much', 'so', 'trained'];
    ...
    // very new variable, always new const
    if (keys[0] === 'very' || keys[0] === 'always') {
        if (keys[0] === 'very') statement += 'var ';
        else if (keys[0] === 'always') statement += 'const ';
        statement +=  keys[1] + ' = ';
