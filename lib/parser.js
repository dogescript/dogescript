...
module.exports = function parse (line) {
    ...
    if (valid.indexOf(keys[0]) === -1 && !assignOps.hasOwnProperty(keys[1]) && keys[1] !== 'dose' || multiComment && keys[0] !== 'loud' || multiLine && keys[0] !== 'wow') return line + '\n';
    ...
    if(assignOps.hasOwnProperty(assignment))
    {
      ...
      // only support new for is, others don't make sense
      if(assignOps[assignment] === 'is')
      {
         if (keys[2] === 'new') {
